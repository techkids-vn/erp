...
var mlabUrl = "mongodb://admin:admin@ds055575.mlab.com:55575/maindb";
var mainDb = mongoose.createConnection(mlabUrl);
...
mainDb.once('open', function callback() {
    ...
    var mainDBSchema = mongoose.Schema({
        _id: Number,
            url: { type: String, default: 'ds045464.mlab.com' },
    ...
    main.find().exec(function (err, result) {
        if (!err) {
            result.forEach(function (_db, index) {
                ...
                var dbObject = mongoose.createConnection(_db.url);
